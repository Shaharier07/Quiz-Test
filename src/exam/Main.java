...
class OnlineTest extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getActionCommand().equals("Result"))
        {
            ...
            new Fp("Choose any one");
        }
    }
    // SET Questions
    void set()
    {
        jb[4].setSelected(true);//next click
        if(current==0)
        {
    ...
    static class Fp extends JFrame implements ActionListener
    {
        JButton a1,a2,a3;
        JLabel x;
        ...
        Fp(String S)
        {
            ...
            add(a2);
            add(a3);
            x.setBounds(30,40,450,20);
            a1.setBounds(100,140,100,30);
            a2.setBounds(270,140,100,30);
            a3.setBounds(440,140,100,30);
            setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            setLayout(null);
            setLocation(250,100);
            setVisible(true);
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource()==a1){
                new OnlineTest("Quiz Test of Java");

            }
            if(e.getSource()==a2)
            {
                new CPlus("Quiz Test of C++");

            }
            if(e.getSource()==a3)
            {
                new C("Quiz Test of C");
